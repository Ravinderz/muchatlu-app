  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <InputField placeholder="Email address" onChangeText={setEmail} value={email}/>
      ...
      <View style={{justifyContent:'center',alignItems:'center', margin:20}}>
        <Text>Not a member ? <Text style={{color:'#6159E6'}} onPress={() => navigation.navigate('Register')}>Sign Up</Text></Text>
      </View>
    </View>
  );
}
